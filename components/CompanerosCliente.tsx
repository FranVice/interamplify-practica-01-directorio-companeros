      ...
      <div className="relative max-w-xl mx-auto mb-12">
        <label className="block relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-4 bg-zinc-900 border border-zinc-800 rounded-2xl text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all shadow-lg"
          />
        </label>
      </div>

      <ul className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 group/list">
        {filtrados.map((c) => (
