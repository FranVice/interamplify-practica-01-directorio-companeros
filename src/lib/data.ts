// Interfaz que modela cada compañero del directorio. Todos los componentes la usan para el tipado.
...
// Fuente de datos única del equipo. Alimenta listados, detalles, filtros y páginas dinámicas.
// No se añaden arrays estáticos adicionales; todo se deriva de este array (requisito técnico).
export const coworkers: Coworker[] = [
  ...
  },
  {
    ...
    rol: "Social Media SEO",
    bio: "Integración de señales sociales en estrategias SEO y gestión de presencia de marca.",
    tecnologias: ["Hootsuite", "Semrush", "Google Analytics 4", "Notion", "Canva"],
  },
  {
    id: "ivan-molina",
    nombre: "Iván Molina",
    rol: "Performance Engineer",
    bio: "Optimización de Core Web Vitals, lazy loading y estrategias de caché para máximo rendimiento.",
    tecnologias: ["Next.js", "Lighthouse", "Chrome DevTools", "Webpack", "Vercel"],
  },
];
