/**
 * Homepage: Página de inicio del Directorio de Compañeros.
 * Presenta una estética moderna con cuadrículas decorativas (lilas) y
 * llamadas a la acción (CTAs) para explorar el directorio o las tecnologías.
 */
...
export default function Home() {
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100 p-8 relative overflow-hidden selection:bg-blue-500/30">
      ...
      {/* ── Fondo decorativo ── 
           Cuadrícula estilo 'Grid' con degradado radial para enfoque central. */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#8b5cf6_1px,transparent_1px),linear-gradient(to_bottom,#8b5cf6_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_0%,#000_70%,transparent_100%)] opacity-30 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto pt-24 md:pt-32">
        ...
        <div className="flex flex-col items-center text-center space-y-8 mb-24">
          ...
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-none animate-fade-in-up">
            Expertos que <br />
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl font-light leading-relaxed animate-fade-in-up [animation-delay:200ms]">
            Descubre a los profesionales certificados en SEO, Desarrollo y Estrategia 
            detrás de los proyectos digitales más ambiciosos.
          </p>

          {/* CTAs: Botones de navegación principal */}
          <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-fade-in-up [animation-delay:400ms]">
            ...
            <Link
              href="/tecnologias"
              className="px-8 py-4 bg-zinc-900 border border-zinc-800 hover:border-zinc-700 text-white rounded-2xl font-bold transition-all hover:bg-zinc-800 flex items-center justify-center gap-2"
            >
              Tecnologías
            </Link>
          </div>
        ...
        {/* ── Sección de Features (Tarjetas Informativas) ── */}
        ...
        {/* ── Footer de Inicio ── */}
        <footer className="mt-32 pt-12 border-t border-zinc-900 pb-12 flex flex-col md:flex-row justify-between items-center gap-6 text-zinc-600 text-sm">
          <p>© 2024 Interamplify Directory. Expertise that Scales.</p>
          <div className="flex gap-8">
            <Link href="/companeros" className="hover:text-blue-500 transition-colors">Directorio</Link>
            <Link href="/tecnologias" className="hover:text-blue-500 transition-colors">Tecnologías</Link>
